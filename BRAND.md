...
The **code** in this repository is licensed under the Apache 2.0 License—you're free to use, modify, and distribute it.

The **brand** (name, logo, visual identity) is separately protected and not covered by the Apache 2.0 License.

---

## Questions

For brand usage questions or permission requests, open an [issue](https://github.com/blackwell-systems/gcp-secret-manager-emulator/issues) or contact the maintainer.
